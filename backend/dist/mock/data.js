...
exports.mockStats = exports.mockInvestigationByIdentifier = exports.mockRiskByIdentifier = void 0;
exports.generateLast30DaysSeries = generateLast30DaysSeries;
exports.mockStrategyForPrefix = mockStrategyForPrefix;
exports.mockRiskByIdentifier = {
    '+8613800138000': {
...
exports.mockInvestigationByIdentifier = {
    '+8613800138000': {
        connectedRate: 0.31,
...
function generateLast30DaysSeries(label = '诈骗告警数') {
    const now = new Date();
...
function mockStrategyForPrefix(prefix) {
